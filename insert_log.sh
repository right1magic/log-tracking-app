...
while IFS=$',' read -r logtype logdate loguser logendpoint; do
    ...
    "INSERT INTO $MYSQL_TABLE ( log_type, log_timestamp, url, method, user_id, transaction_id, product_id, cart_id, order_id, payload, client_ip, user_agent, referer) VALUES ( '$log_type', '$log_timestamp', '$url', '$method', '$user_id', '$transaction_id',
